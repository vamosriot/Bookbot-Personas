// Node.js compatible constants for scripts
// This file mirrors constants.ts but uses process.env instead of import.meta.env
...
export const CLOUDFLARE_WORKER_URL = process.env.VITE_CLOUDFLARE_WORKER_URL || process.env.CLOUDFLARE_WORKER_URL || '';
